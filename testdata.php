...
$query2 = "select * from adm order by rollno desc limit 1";
...
$sname = $_REQUEST['sname'];
    ...
    $qname = $_REQUEST['qname'];
    $zname = $_REQUEST['zname'];
$sql="INSERT INTO `adm` ( `rollno`,`Studentname`, `fathersname`, `dob`, `gender`, `degree`, `email`, `mobileno`, `address`, `state`, `district`, `pincode`, `Qualification`, `percentage`) VALUES ('$customer_ID' ,'$sname', '$fname', '$cname', '$gname', '$dk', '$ename', '$mname', '$aname', '$stname', '$dname', '$pinname', '$qname', '$zname')";
